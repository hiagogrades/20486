...
using System.IO; //ToDo: 1 adicionar a biblioteca
...
namespace ButterfliesShop.Controllers
{
    public class ButterflyController : Controller
    {
        ...
        //ToDo: 2 Criou um novo método do tipo IAction e denomenou de Index();
        public IActionResult Index()
        {
            //Instância um novo objeto do tipo indexViewModel
        ...
        {
            //Cria um objeto do tipo Butterfly
